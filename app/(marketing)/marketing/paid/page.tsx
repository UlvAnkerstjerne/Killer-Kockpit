...
export default async function PaidPage({ searchParams }: {
  ...
  return (
    <div className="min-w-0">
      <div className="mb-5">
        <h1 className="text-8xl font-black tracking-tight text-kk-ink leading-none flex items-center gap-4">
          <span className="flex items-center gap-3">
            <svg width="80" height="80" viewBox="0 0 24 24" fill="none" aria-hidden="true" className="shrink-0">
              <defs>
                <linearGradient id="ig-grad" x1="1" y1="23" x2="23" y2="1">
              ...
              <circle cx="12" cy="12" r="5" stroke="url(#ig-grad)" strokeWidth="1.8"/>
              <circle cx="18" cy="6" r="1.2" fill="url(#ig-grad)"/>
            </svg>
            <span className="text-kk-muted text-7xl font-light">/</span>
            <svg width="80" height="80" viewBox="0 0 24 24" aria-hidden="true" className="shrink-0">
